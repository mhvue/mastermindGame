...
$("#submitBtn").click(function(event){
   ...
   else if(userNum > "7777" || userNum.includes("8") || userNum.includes("9") ){
...
//messages to user
    if(checker.length === 4) {
        ...
        const correctMsg = $("<h5> You got all the numbers corret. Play Again?</h5>").addClass("text-position")
...
$("#hint-btn").click(function() {
   ...
   $(".modal-title").removeClass().addClass("hint-title");
